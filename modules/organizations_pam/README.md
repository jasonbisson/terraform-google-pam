...
| entitlements | Entitlements for each project | <pre>list(object({<br>    organization           = string<br>    entitlement_prefix = string<br>    role               = string<br>    expression         = string<br>    eligible_users     = list(string)<br>    approvers          = list(string)<br>  }))</pre> | n/a | yes |
